...
class EnrichPiiSpec extends PipelineSpec {
  ...
  val expected = List(
    ...
    "5198e6a261e35b7783f8a86b81fe1a35b9ea1e77",
    "1804954790",
    "3c1757544e39bca4",
    "26",
  ...
  val pii = List(
    ...
    "2014-02-02 22:01:20.941",
    "pii_transformation",
    "beam-enrich-0.1.0-rc2-common-0.35.0",
    ...
    """{"schema":"iglu:com.snowplowanalytics.snowplow/unstruct_event/jsonschema/1-0-0","data":{"schema":"iglu:com.snowplowanalytics.snowplow/pii_transformation/jsonschema/1-0-0","data":{"pii":{"pojo":[{"fieldName":"user_ipaddress","originalValue":"10.0.2.2","modifiedValue":"5198e6a261e35b7783f8a86b81fe1a35b9ea1e77"},{"fieldName":"user_id","originalValue":"alex 123","modifiedValue":"d1a21f2589511b4ed04ee297d88d950efb2612dc"}]},"strategy":{"pseudonymize":{"hashFunction":"SHA-1"}}}}}""",
  ...
  "Enrich" should "enrich a struct event with pii information" in {
    JobTest[Enrich.type]
